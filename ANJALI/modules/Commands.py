...
from ANJALI.database.chats import add_served_chat
from ANJALI.database.users import add_served_user
from config import MONGO_URL, OWNER_ID
from ANJALI import ANJALI, mongo, LOGGER, db
from ANJALI.modules.helpers import chatai, storeai, languages, CHATBOT_ON
...
@ANJALI.on_message(filters.command(["lang", "language", "setlang"]))
...
@ANJALI.on_message(filters.command("status"))
...
@ANJALI.on_message(filters.command(["resetlang", "nolang"]))
...
@ANJALI.on_message(filters.command("chatbot"))
